...
def depthwise_conv2d(input: paddle.Tensor, filter: paddle.Tensor, strides: list[int] = [1, 1], paddings: list[int] = [0, 0], padding_algorithm: str = "EXPLICIT", groups: int = 1, dilations: list[int] = [1, 1], data_format: str = "NCHW") -> paddle.Tensor:
    ...
    """
def depthwise_conv2d_bias(input: paddle.Tensor, filter: paddle.Tensor, bias: paddle.Tensor, strides: list[int] = [1, 1], paddings: list[int] = [0, 0], padding_algorithm: str = "EXPLICIT", groups: int = 1, dilations: list[int] = [1, 1], data_format: str = "NCHW") -> paddle.Tensor:
    """
    C++ interface function for depthwise_conv2d_bias in dygraph.
    """
def depthwise_conv2d_bias_grad(*args, **kwargs):
    """
    C++ interface function for depthwise_conv2d_bias_grad in dygraph.
    """
...
def depthwise_conv2d_transpose_grad(*args, **kwargs):
    ...
    """
def depthwise_conv3d_bias(input: paddle.Tensor, filter: paddle.Tensor, bias: paddle.Tensor, strides: list[int] = [1, 1, 1], paddings: list[int] = [0, 0, 0], padding_algorithm: str = "EXPLICIT", groups: int = 1, dilations: list[int] = [1, 1, 1], data_format: str = "NCDHW") -> paddle.Tensor:
    """
    C++ interface function for depthwise_conv3d_bias in dygraph.
    """
def depthwise_conv3d_bias_grad(*args, **kwargs):
    """
    C++ interface function for depthwise_conv3d_bias_grad in dygraph.
    """
...
def distribute_fpn_proposals(*args, **kwargs):
    ...
    """
def div_scale(*args, **kwargs):
    """
    C++ interface function for div_scale in dygraph.
    """
...
def fp8_gemm_blockwise_(A: paddle.Tensor, A_scale: paddle.Tensor, B: paddle.Tensor, B_scale: paddle.Tensor, input_result: paddle.Tensor, bias: paddle.Tensor, pre_gelu: paddle.Tensor, workspace: paddle.Tensor, transa: bool, transb: bool, grad: bool, accumulate: bool, use_split_accumulator: bool, math_sm_count: int, is_A_1d_scaled: bool, is_B_1d_scaled: bool) -> tuple[paddle.Tensor, paddle.Tensor, paddle.Tensor]:
    ...
    """
def fp8_quant_blockwise(x: paddle.Tensor, epsilon: float, using_1x128_vec_quant: bool, input_transpose: bool, output_scale_transpose: bool, return_transpose_only: bool, using_e5m2: bool, using_pow2_scale: bool, using_ue8m0_scale: bool) -> tuple[paddle.Tensor, paddle.Tensor, paddle.Tensor, paddle.Tensor]:
    """
...
def linear_interp_grad(*args, **kwargs):
    ...
    """
def linear_v2(input: paddle.Tensor, weight: paddle.Tensor, bias: paddle.Tensor, transpose_weight: bool = False) -> paddle.Tensor:
    """
    C++ interface function for linear_v2 in dygraph.
    """
def linear_v2_grad(*args, **kwargs):
    """
    C++ interface function for linear_v2_grad in dygraph.
    """
...
def moe_gate_dispatch_permute_grad(*args, **kwargs):
    ...
    """
def moe_permute(hidden_states: paddle.Tensor, scale: paddle.Tensor, expert_routemap_topk: paddle.Tensor, expert_prob_topk: paddle.Tensor, num_experts: int, tokens_per_expert: list[int], padding_alignment: int, do_gather: bool, using_ue8m0_scale: bool = False, return_expert_indices: bool = False, override_buffer_size: int = -1) -> tuple[paddle.Tensor, paddle.Tensor, paddle.Tensor, paddle.Tensor, paddle.Tensor]:
    """
    C++ interface function for moe_permute in dygraph.
    """
def moe_unpermute(hidden_states_unzipped: paddle.Tensor, zipped_expertwise_rowmap: paddle.Tensor, expert_routemap_topk: paddle.Tensor, token_prob_unzipped: paddle.Tensor, total_zipped_tokens_num: int, num_experts: int, use_mix_precision: bool, using_weighted_combine: bool = False) -> tuple[paddle.Tensor, paddle.Tensor]:
    """
...
def nanmedian_grad(*args, **kwargs):
    ...
    """
def nansum(x: paddle.Tensor, axis: list[int] = [], dtype: paddle._typing.DTypeLike = "DataType::UNDEFINED", keepdim: bool = False) -> paddle.Tensor:
    """
    C++ interface function for nansum in dygraph.
    """
def nansum_grad(*args, **kwargs):
    """
    C++ interface function for nansum_grad in dygraph.
    """
...
def rint_grad_(*args, **kwargs):
    ...
    """
def rms_norm(x: paddle.Tensor, scale: paddle.Tensor, normalized_shape: list[int] = [], epsilon: float = 1e-5) -> tuple[paddle.Tensor, paddle.Tensor]:
    """
...
def stanh_grad(*args, **kwargs):
    ...
    """
def std(x: paddle.Tensor, axis: list[int] = [], keepdim: bool = False, unbiased: bool = True, correction: float = 1) -> paddle.Tensor:
    """
    C++ interface function for std in dygraph.
    """
def std_grad(*args, **kwargs):
    """
    C++ interface function for std_grad in dygraph.
    """
...
def update_loss_scaling_(x: list[paddle.Tensor], found_infinite: paddle.Tensor, prev_loss_scaling: paddle.Tensor, in_good_steps: paddle.Tensor, in_bad_steps: paddle.Tensor, incr_every_n_steps: int, decr_every_n_nan_or_inf: int, incr_ratio: float, decr_ratio: float, stop_update: float = False) -> tuple[list[paddle.Tensor], paddle.Tensor, paddle.Tensor, paddle.Tensor]:
    ...
    """
def var(x: paddle.Tensor, axis: list[int] = [], keepdim: bool = False, unbiased: bool = True, correction: float = 1) -> paddle.Tensor:
    """
    C++ interface function for var in dygraph.
    """
def var_grad(*args, **kwargs):
    """
    C++ interface function for var_grad in dygraph.
    """
