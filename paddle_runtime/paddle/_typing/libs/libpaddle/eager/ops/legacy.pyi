...
__all__: list[str] = ['abs', 'abs_', 'accuracy', 'accuracy_check', 'acos', 'acos_', 'acosh', 'acosh_', 'adadelta', 'adagrad', 'adam', 'adamax', 'adamw', 'add_act_xpu', 'add_group_norm_silu', 'add_layernorm_xpu', 'add_position_encoding', 'addcmul_xpu', 'addmm', 'addmm_', 'affine_channel', 'affine_channel_', 'affine_grid', 'all_gather', 'all_reduce', 'all_reduce_', 'all_to_all', 'allclose', 'anchor_generator', 'angle', 'ap_facade', 'ap_trivial_fusion_begin', 'ap_trivial_fusion_end', 'ap_variadic', 'apply_per_channel_scale', 'arg_max', 'arg_min', 'argsort', 'as_complex', 'as_real', 'as_strided', 'asgd', 'asin', 'asin_', 'asinh', 'asinh_', 'assert', 'assign', 'assign_pos', 'assign_value', 'atan', 'atan2', 'atan_', 'atanh', 'atanh_', 'attention_lstm', 'auc', 'average_accumulates', 'baddbmm', 'baddbmm_', 'barrier', 'batch_fc', 'batch_norm', 'batched_gemm', 'bce_loss', 'bce_loss_', 'beam_search', 'beam_search_decode', 'bernoulli', 'bicubic_interp_v2', 'bilinear_interp', 'bilinear_interp_v2', 'bilinear_tensor_product', 'bincount', 'binomial', 'bipartite_match', 'bitwise_and', 'bitwise_and_', 'bitwise_left_shift', 'bitwise_left_shift_', 'bitwise_not', 'bitwise_not_', 'bitwise_or', 'bitwise_or_', 'bitwise_right_shift', 'bitwise_right_shift_', 'bitwise_xor', 'bitwise_xor_', 'blha_get_max_len', 'block_multihead_attention', 'block_multihead_attention_xpu', 'bmm', 'bn_act_xpu', 'box_clip', 'box_coder', 'brelu', 'brelu_', 'broadcast', 'broadcast_', 'broadcast_tensors', 'build_src_rank_and_local_expert_id', 'c_scatter', 'c_sync_calc_stream', 'c_sync_calc_stream_', 'cal_aux_loss', 'calc_reduced_attn_scores', 'cast', 'ceil', 'ceil_', 'celu', 'channel_shuffle', 'check_finite_and_unscale', 'check_finite_and_unscale_', 'check_numerics', 'cholesky', 'cholesky_solve', 'chunk_eval', 'class_center_sample', 'clip', 'clip_', 'clip_by_norm', 'coalesce_tensor', 'collect_fpn_proposals', 'comm_init_all', 'complex', 'concat', 'conj', 'conv1d_xpu', 'conv2d', 'conv2d_transpose', 'conv2d_transpose_bias', 'conv2d_transpose_xpu', 'conv2d_xpu', 'conv3d', 'conv3d_transpose', 'copysign', 'copysign_', 'correlation', 'cos', 'cos_', 'cosh', 'cosh_', 'crf_decoding', 'crop', 'crop_tensor', 'cross', 'cross_attention_xpu', 'cross_entropy', 'cross_entropy2', 'cross_entropy_with_softmax_bwd_w_downcast', 'ctc_align', 'cudnn_lstm', 'cummax', 'cummin', 'cumprod', 'cumprod_', 'cumsum', 'cumsum_', 'cvm', 'data', 'decayed_adagrad', 'decode_jpeg', 'deformable_conv', 'deformable_conv_v1', 'depend', 'depthwise_conv2d', 'depthwise_conv2d_bias', 'depthwise_conv2d_transpose', 'depthwise_conv3d_bias', 'dequantize', 'dequantize_abs_max', 'dequantize_linear', 'dequantize_log', 'dequantize_xpu', 'determinant', 'dgc', 'dgc_clip_by_norm', 'dgc_momentum', 'diag_embed', 'diag_v2', 'diagonal', 'digamma', 'digamma_', 'dirichlet', 'dist', 'dist_concat', 'distribute_fpn_proposals', 'distributed_fused_lamb_init', 'dot', 'dpsgd', 'dropout', 'edit_distance', 'eig', 'eigh', 'eigvals', 'eigvalsh', 'einsum', 'elementwise_add', 'elementwise_add_', 'elementwise_div', 'elementwise_floordiv', 'elementwise_fmax', 'elementwise_fmin', 'elementwise_heaviside', 'elementwise_max', 'elementwise_min', 'elementwise_mod', 'elementwise_mod_', 'elementwise_mul', 'elementwise_pow', 'elementwise_sub', 'elementwise_sub_', 'elu', 'elu_', 'embedding_grad_add_to', 'embedding_grad_add_to_', 'embedding_with_eltwise_add_xpu', 'embedding_with_scaled_gradient', 'empty', 'equal', 'equal_all', 'erf', 'erf_', 'erfinv', 'erfinv_', 'exp', 'exp_', 'expand', 'expand_as_v2', 'expand_modality_expert_id', 'expand_v2', 'expm1', 'expm1_', 'exponential', 'exponential_', 'eye', 'fake_channel_wise_dequantize_max_abs', 'fake_channel_wise_quantize_abs_max', 'fake_channel_wise_quantize_dequantize_abs_max', 'fake_dequantize_max_abs', 'fake_quantize_abs_max', 'fake_quantize_dequantize_abs_max', 'fake_quantize_dequantize_moving_average_abs_max', 'fake_quantize_dequantize_moving_average_abs_max_', 'fake_quantize_moving_average_abs_max', 'fake_quantize_moving_average_abs_max_', 'fake_quantize_range_abs_max', 'fake_quantize_range_abs_max_', 'fast_layernorm_xpu', 'fast_ln', 'fast_rms_norm', 'fast_where_xpu', 'faster_tokenizer', 'fc', 'fc_xpu', 'feed', 'fetch', 'fetch_barrier', 'fetch_v2', 'fft_c2c', 'fft_c2r', 'fft_r2c', 'fill', 'fill_any', 'fill_any_', 'fill_any_like', 'fill_constant', 'fill_constant_batch_size_like', 'fill_diagonal', 'fill_diagonal_', 'fill_diagonal_tensor', 'fill_diagonal_tensor_', 'flash_attn', 'flash_attn_qkvpacked', 'flash_attn_unpadded', 'flash_attn_v3', 'flash_attn_v3_varlen', 'flash_attn_varlen_qkvpacked', 'flashmask_attention', 'flashmask_attention_v2', 'flatten2', 'flatten2_', 'flatten_contiguous_range', 'flatten_contiguous_range_', 'flip', 'floor', 'floor_', 'fold', 'fp8_fp8_half_gemm_fused', 'fp8_gemm_blockwise', 'fp8_quant_blockwise', 'fractional_max_pool2d', 'fractional_max_pool3d', 'frame', 'frobenius_norm', 'ftrl', 'full_int_array', 'fused_act_dequant', 'fused_adam', 'fused_bias_act', 'fused_bias_dropout_residual_layer_norm', 'fused_bias_residual_layernorm', 'fused_conv2d', 'fused_conv2d_add_act', 'fused_conv3d', 'fused_dconv_drelu_dbn', 'fused_dot_product_attention', 'fused_dropout_add', 'fused_elementwise_add', 'fused_elementwise_div', 'fused_elementwise_mul', 'fused_elementwise_sub', 'fused_elemwise_activation', 'fused_elemwise_add_activation', 'fused_embedding_eltwise_layernorm', 'fused_embedding_fc_lstm', 'fused_fc_elementwise_layernorm', 'fused_linear_param_grad_add', 'fused_matmul', 'fused_multi_transformer', 'fused_multi_transformer_', 'fused_multi_transformer_int8_xpu', 'fused_multi_transformer_xpu', 'fused_partial_rope', 'fused_rms_norm_ext', 'fused_rms_norm_quant', 'fused_rotary_position_embedding', 'fused_scale_bias_add_relu', 'fused_scale_bias_relu_conv_bn', 'fused_seqpool_cvm', 'fused_softmax_mask', 'fused_softmax_mask_upper_triangle', 'fused_softplus', 'fused_stack_quant', 'fused_stack_transpose_quant', 'fused_swiglu_weighted_bwd', 'fused_token_prune', 'fused_transpose', 'fused_transpose_split_quant', 'fused_transpose_wlch_split_quant', 'fused_weighted_swiglu_act_quant', 'fusion_group', 'fusion_gru', 'fusion_lstm', 'fusion_repeated_fc_relu', 'fusion_seqconv_eltadd_relu', 'fusion_seqpool_concat', 'fusion_seqpool_cvm_concat', 'fusion_squared_mat_sub', 'fusion_transpose_flatten_concat', 'gammaincc', 'gammaincc_', 'gammaln', 'gammaln_', 'gather', 'gather_nd', 'gather_tree', 'gaussian_inplace', 'gaussian_inplace_', 'gaussian_random', 'gelu', 'gemm_epilogue', 'generate_proposals', 'generate_proposals_v2', 'generate_sequence_xpu', 'get_core_ops_args_info', 'get_core_ops_args_type_info', 'get_core_ops_returns_info', 'get_tensor_from_selected_rows', 'global_gather', 'global_scatter', 'grad_add', 'graph_khop_sampler', 'graph_reindex', 'graph_sample_neighbors', 'graph_send_recv', 'graph_send_ue_recv', 'graph_send_uv', 'greater_equal', 'greater_than', 'grid_sampler', 'group_norm', 'group_norm_silu_xpu', 'gru', 'gru_unit', 'gumbel_softmax', 'hard_shrink', 'hard_sigmoid', 'hard_swish', 'hash', 'hierarchical_sigmoid', 'hinge_loss', 'histogram', 'huber_loss', 'i0', 'i0_', 'i0e', 'i1', 'i1e', 'identity_loss', 'identity_loss_', 'im2sequence', 'imag', 'increment', 'index_add', 'index_add_', 'index_elementwise_get', 'index_elementwise_put', 'index_elementwise_put_', 'index_elementwise_put_with_tensor', 'index_elementwise_put_with_tensor_', 'index_put', 'index_put_', 'index_sample', 'index_select', 'index_select_strided', 'instance_norm', 'int_bincount', 'interp_antialias', 'inverse', 'is_empty', 'isclose', 'isfinite_v2', 'isinf_v2', 'isnan_v2', 'kldiv_loss', 'kron', 'kthvalue', 'l1_norm', 'l1_norm_', 'label_smooth', 'lamb', 'lars_momentum', 'layer_norm', 'layer_norm_act_xpu', 'layer_norm_relu_xpu', 'leaky_relu', 'leaky_relu_', 'lerp', 'lerp_', 'less_equal', 'less_than', 'lgamma', 'lgamma_', 'limit_by_capacity', 'linear_interp_v2', 'linear_v2', 'linspace', 'llm_int8_linear', 'load', 'load_combine', 'lod_reset', 'lod_reset_', 'log', 'log10', 'log10_', 'log1p', 'log1p_', 'log2', 'log2_', 'log_', 'log_loss', 'log_softmax', 'logcumsumexp', 'logical_and', 'logical_and_', 'logical_not', 'logical_not_', 'logical_or', 'logical_or_', 'logical_xor', 'logical_xor_', 'logit', 'logit_', 'logsigmoid', 'logspace', 'logsumexp', 'lookup_table', 'lookup_table_dequant', 'lookup_table_v2', 'lp_pool2d', 'lrn', 'lstm', 'lstsq', 'lu', 'lu_', 'lu_solve', 'lu_unpack', 'margin_cross_entropy', 'mask_adaptive_xpu', 'masked_fill', 'masked_fill_', 'masked_multihead_attention', 'masked_select', 'match_matrix_tensor', 'matmul', 'matmul_v2', 'matrix_nms', 'matrix_power', 'matrix_rank', 'matrix_rank_atol_rtol', 'max_pool2d_v2', 'max_pool2d_with_index', 'max_pool3d_with_index', 'max_with_index', 'maxout', 'mean', 'median', 'memcpy', 'memcpy_d2h', 'memcpy_h2d', 'memory_efficient_attention', 'merge_selected_rows', 'merged_adam', 'merged_momentum', 'meshgrid', 'min_with_index', 'mish', 'mode', 'moe_combine', 'moe_combine_auto', 'moe_combine_no_weight', 'moe_gate_dispatch', 'moe_gate_dispatch_and_quant', 'moe_gate_dispatch_auto', 'moe_gate_dispatch_partial_nosoftmaxtopk', 'moe_gate_dispatch_permute', 'moe_permute', 'moe_unpermute', 'momentum', 'moving_average_abs_max_scale', 'mul', 'multi_dot', 'multi_encoder_xpu', 'multi_gru', 'multiclass_nms', 'multiclass_nms3', 'multihead_matmul', 'multinomial', 'multiplex', 'mv', 'nadam', 'nanmedian', 'nansum', 'nce', 'nearest_interp', 'nearest_interp_v2', 'nextafter', 'nll_loss', 'nms', 'nop', 'norm', 'not_equal', 'npu_identity', 'number_count', 'one_hot_v2', 'overlap_add', 'p_norm', 'p_recv', 'p_recv_array', 'p_send', 'p_send_array', 'pad', 'pad2d_xpu', 'pad3d', 'partial_allgather', 'partial_allgather_', 'partial_concat', 'partial_sum', 'pixel_shuffle', 'pixel_unshuffle', 'poisson', 'polygamma', 'polygamma_', 'pool2d', 'pool3d', 'pow', 'pow_', 'prelu', 'prior_box', 'prune_gate_by_capacity', 'psroi_pool', 'put_along_axis', 'put_along_axis_', 'pyramid_hash', 'qkv_attention_xpu', 'qkv_unpack_mha', 'qr', 'quant_linear', 'quantize', 'quantize_linear', 'quantize_xpu', 'radam', 'randint', 'random', 'random_', 'random_routing', 'random_routing_', 'randperm', 'range', 'range_v2', 'rank_attention', 'read_file', 'real', 'reciprocal', 'reciprocal_', 'reduce', 'reduce_', 'reduce_all', 'reduce_amax', 'reduce_amin', 'reduce_any', 'reduce_as', 'reduce_max', 'reduce_mean', 'reduce_min', 'reduce_prod', 'reduce_scatter', 'reduce_sum', 'relu', 'relu6', 'relu_', 'renorm', 'renorm_', 'repeat_interleave', 'requantize', 'reshape', 'reshape2', 'reshape2_', 'reshape_', 'resnet_basic_block', 'resnet_unit', 'restrict_nonzero', 'reverse', 'rint', 'rint_', 'rms_norm', 'rmsprop', 'rnn', 'roformer_relative_embedding_xpu', 'roi_align', 'roi_pool', 'roll', 'round', 'round_', 'row_conv', 'rprop', 'rrelu', 'rsqrt', 'rsqrt_', 'run_program', 'save', 'save_combine', 'scale', 'scale_', 'scatter', 'scatter_', 'scatter_nd_add', 'searchsorted', 'seed', 'segment_pool', 'self_dp_attention', 'selu', 'sequence_conv', 'sequence_expand', 'sequence_mask', 'sequence_pool', 'sequence_softmax', 'sequence_unpad_xpu', 'set', 'set_', 'set_value', 'set_value_', 'sgd', 'shadow_output', 'shape', 'shape64', 'shard_index', 'share_buffer', 'share_data', 'shuffle_batch', 'shuffle_channel', 'sigmoid', 'sigmoid_', 'sigmoid_cross_entropy_with_logits', 'sigmoid_cross_entropy_with_logits_', 'sign', 'silu', 'silu_', 'sin', 'sin_', 'sine_pos_xpu', 'sinh', 'sinh_', 'size', 'skip_layernorm', 'slice', 'slogdet_v2', 'slogdeterminant', 'softmax', 'softmax_', 'softmax_with_cross_entropy', 'softmax_with_cross_entropy_', 'softplus', 'softshrink', 'softsign', 'solve', 'sparse_attention', 'sparse_momentum', 'spatial_transformer_resblock_xpu', 'spectral_norm', 'split', 'sqrt', 'sqrt_', 'square', 'square_', 'squared_l2_norm', 'squeeze2', 'squeeze2_', 'squeeze_excitation_block', 'stack', 'standard_gamma', 'stanh', 'std', 'stft', 'strided_slice', 'sum', 'svd', 'svdvals', 'swiglu', 'swish', 'take_along_axis', 'tan', 'tan_', 'tanh', 'tanh_', 'tanh_shrink', 'tdm_child', 'tdm_sampler', 'temporal_shift', 'thresholded_relu', 'thresholded_relu_', 'tile', 'top_k', 'top_k_v2', 'top_p_sampling', 'trace', 'transfer_layout', 'transpose', 'transpose2', 'triangular_solve', 'tril_indices', 'tril_triu', 'trilinear_interp_v2', 'triu_indices', 'trunc', 'trunc_', 'trunc_divide', 'trunc_divide_', 'truncated_gaussian_random', 'unbind', 'unfold', 'uniform_random', 'uniform_random_batch_size_like', 'uniform_random_inplace', 'uniform_random_inplace_', 'unique', 'unique_consecutive', 'unpool', 'unpool3d', 'unsqueeze2', 'unsqueeze2_', 'unstack', 'update_loss_scaling', 'var', 'variable_length_memory_efficient_attention', 'variance', 'view_dtype', 'view_shape', 'view_slice', 'viterbi_decode', 'warpctc', 'warprnnt', 'weight_dequantize', 'weight_only_linear', 'weight_quantize', 'weighted_sample_neighbors', 'where', 'where_', 'where_index', 'yolo_box', 'yolo_box_head', 'yolo_box_post', 'yolo_box_xpu', 'yolov3_loss']
def abs(*args, **kwargs):
    """
...
def broadcast_tensors(*args, **kwargs):
    ...
    """
def build_src_rank_and_local_expert_id(*args, **kwargs):
    """
...
def collect_fpn_proposals(*args, **kwargs):
    ...
    """
def comm_init_all(*args, **kwargs):
    """
    C++ interface function for comm_init_all in dygraph.
    """
...
def cross_entropy2(*args, **kwargs):
    ...
    """
def cross_entropy_with_softmax_bwd_w_downcast(*args, **kwargs):
    """
...
def depthwise_conv2d(*args, **kwargs):
    ...
    """
def depthwise_conv2d_bias(*args, **kwargs):
    """
    C++ interface function for depthwise_conv2d_bias in dygraph.
    """
def depthwise_conv2d_transpose(*args, **kwargs):
    """
    C++ interface function for depthwise_conv2d_transpose in dygraph.
    """
def depthwise_conv3d_bias(*args, **kwargs):
    """
    C++ interface function for depthwise_conv3d_bias in dygraph.
    """
...
def elu_(*args, **kwargs):
    ...
    """
def embedding_grad_add_to(*args, **kwargs):
    """
    C++ interface function for embedding_grad_add_to in dygraph.
    """
def embedding_grad_add_to_(*args, **kwargs):
    """
...
def embedding_with_eltwise_add_xpu(*args, **kwargs):
    ...
    """
def embedding_with_scaled_gradient(*args, **kwargs):
    """
...
def expand_as_v2(*args, **kwargs):
    ...
    """
def expand_modality_expert_id(*args, **kwargs):
    """
...
def fast_layernorm_xpu(*args, **kwargs):
    ...
    """
def fast_ln(*args, **kwargs):
    """
    C++ interface function for fast_ln in dygraph.
    """
def fast_rms_norm(*args, **kwargs):
    """
...
def flash_attn_unpadded(*args, **kwargs):
    ...
    """
def flash_attn_v3(*args, **kwargs):
    """
    C++ interface function for flash_attn_v3 in dygraph.
    """
def flash_attn_v3_varlen(*args, **kwargs):
    """
...
def flashmask_attention(*args, **kwargs):
    ...
    """
def flashmask_attention_v2(*args, **kwargs):
    """
...
def fp8_fp8_half_gemm_fused(*args, **kwargs):
    ...
    """
def fp8_gemm_blockwise(*args, **kwargs):
    """
    C++ interface function for fp8_gemm_blockwise in dygraph.
    """
def fp8_quant_blockwise(*args, **kwargs):
    """
...
def fused_partial_rope(*args, **kwargs):
    ...
    """
def fused_rms_norm_ext(*args, **kwargs):
    """
    C++ interface function for fused_rms_norm_ext in dygraph.
    """
def fused_rms_norm_quant(*args, **kwargs):
    """
...
def fused_softmax_mask_upper_triangle(*args, **kwargs):
    ...
    """
def fused_softplus(*args, **kwargs):
    """
    C++ interface function for fused_softplus in dygraph.
    """
...
def instance_norm(*args, **kwargs):
    ...
    """
def int_bincount(*args, **kwargs):
    """
    C++ interface function for int_bincount in dygraph.
    """
def interp_antialias(*args, **kwargs):
    """
...
def layer_norm_act_xpu(*args, **kwargs):
    ...
    """
def layer_norm_relu_xpu(*args, **kwargs):
    """
    C++ interface function for layer_norm_relu_xpu in dygraph.
    """
...
def linear_interp_v2(*args, **kwargs):
    ...
    """
def linear_v2(*args, **kwargs):
    """
    C++ interface function for linear_v2 in dygraph.
    """
...
def max_pool3d_with_index(*args, **kwargs):
    ...
    """
def max_with_index(*args, **kwargs):
    """
...
def meshgrid(*args, **kwargs):
    ...
    """
def min_with_index(*args, **kwargs):
    """
...
def nansum(*args, **kwargs):
    """
    C++ interface function for nansum in dygraph.
    """
def nce(*args, **kwargs):
    """
...
def pad3d(*args, **kwargs):
    ...
    """
def partial_allgather(*args, **kwargs):
    """
    C++ interface function for partial_allgather in dygraph.
    """
def partial_allgather_(*args, **kwargs):
    """
...
def resnet_unit(*args, **kwargs):
    ...
    """
def restrict_nonzero(*args, **kwargs):
    """
...
def std(*args, **kwargs):
    """
    C++ interface function for std in dygraph.
    """
...
def trunc_(*args, **kwargs):
    ...
    """
def trunc_divide(*args, **kwargs):
    """
    C++ interface function for trunc_divide in dygraph.
    """
def trunc_divide_(*args, **kwargs):
    """
...
def var(*args, **kwargs):
    """
    C++ interface function for var in dygraph.
    """
